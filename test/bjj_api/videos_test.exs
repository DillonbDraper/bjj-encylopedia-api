defmodule BJJ.VideosTest do
  ...
  describe "videos" do
    ...
    @valid_attrs %{description: "some description", gi: true, technique_id: 42, thumbnail: "some thumbnail", title: "some title", url: "some url"}
    @update_attrs %{description: "some updated description", gi: false, technique_id: 43, thumbnail: "some updated thumbnail", title: "some updated title", url: "some updated url"}
    @invalid_attrs %{description: nil, gi: nil, technique_id: nil, thumbnail: nil, title: nil, url: nil}
    ...
    test "create_video/1 with valid data creates a video" do
      ...
      assert video.gi == true
      assert video.technique_id == 42
    ...
    test "update_video/2 with valid data updates the video" do
      ...
      assert video.gi == false
      assert video.technique_id == 43
